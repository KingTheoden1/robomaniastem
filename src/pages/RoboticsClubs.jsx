    ...
    <>
      ...
      <div className="program-item alternate">
        ...
        <div>
          ...
          <button onClick={() => window.location.href = 'https://www.paypal.com/webapps/shoppingcart?mfid=1706834126426_f785484e281f0&flowlogging_id=f785484e281f0#/checkout/shoppingCart'}>Monday<br />5:30-6:30pm <br /> <h1>Click to Enroll</h1></button>
          <br />
          <button onClick={() => window.location.href = 'https://www.paypal.com/webapps/shoppingcart?mfid=1706834126426_f785484e281f0&flowlogging_id=f785484e281f0#/checkout/shoppingCart'}>Tuesday<br />5:30-6:30pm <br /> <h1>Click to Enroll</h1></button>
        </div>
      </div>
